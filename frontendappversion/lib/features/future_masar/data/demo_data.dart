...
// ═══════════════ المنح ═══════════════
// 🎓 **نُقلت خارج الديمو بالكامل (2026-08-29).** المنح صارت ميزةً حقيقية
//    مصدرها الخادم واللوحة: `features/scholarships/`. لا تُعِد قائمةً ثابتة
//    هنا أبداً — منحة في الكود تعني نشرَ تطبيقٍ لتصحيح تاريخ إغلاق.
