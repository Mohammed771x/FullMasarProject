...
# 🔴🔴 **وحدُّ الكلمةِ لا يقلُّ خطراً عن حدِّ المادة** (2026-09-17):
#    «مضروب» اسمٌ، و«مضروبة/مضروباً/مضروبا» **اسمُ مفعولٍ يعني الضربَ نفسَه**
#    — «الكتلة **مضروبة** في التسارع». وكان النمطُ بلا حدٍّ بعد الباء، فالتقط
#    «مضروب» من داخل «مضروبة» ثم أخذ «ة» مقداراً (حرفٌ عربيٌّ مفرد!) فخرج
#    للطالب «الكتلة ⌋ة في التسارع» — **٢٧ موضعاً** في الفيزياء والكيمياء
#    والرياضيات، رآها المالكُ في اختبر نفسك.
#    ⭐ والحدُّ: بعد «مضروب» **لا يجوز حرفٌ عربيٌّ آخر** (والتشكيلُ يُتخطّى،
#      فـ«مضروبُ ن» اسمٌ مشكولٌ لا صيغةَ مفعول). و«اً» ألفٌ فحرفٌ ⇒ تُرفض.
_WORD = re.compile(r"(?:ال)?مضروب[\u064b-\u0652]*(?![\u0621-\u064a])\s*")
