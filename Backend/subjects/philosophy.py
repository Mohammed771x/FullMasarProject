# ==================================================
# 📘 subjects/philosophy.py — مادة الفلسفة
# ==================================================
...
#   📖 وضع الدروس  → data/subjects/{الصف}/{المسار}/فلسفة/lessons_mode/
#   📄 وضع الوحدات → data/subjects/{الصف}/{المسار}/فلسفة/unit_mode/book.json
...
# 🚦 المعالج الرئيسي
# ══════════════════════════════════════════════════
async def handle_philosophy_request(req, clients: dict) -> dict:
