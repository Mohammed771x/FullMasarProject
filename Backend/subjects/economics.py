# ==================================================
# 📘 subjects/economics.py — مادة علم الاقتصاد
# ==================================================
# الصفوف: الثاني الأدبي
#
...
#   📖 وضع الدروس  → data/subjects/{الصف}/{المسار}/علم الاقتصاد/lessons_mode/
#   📄 وضع الوحدات → data/subjects/{الصف}/{المسار}/علم الاقتصاد/unit_mode/book.json
...
# 🚦 المعالج الرئيسي
# ══════════════════════════════════════════════════
async def handle_economics_request(req, clients: dict) -> dict:
