# ==================================================
# 📘 subjects/sociology.py — مادة علم الاجتماع
# ==================================================
...
#   📖 وضع الدروس  → data/subjects/{الصف}/{المسار}/علم الاجتماع/lessons_mode/
#   📄 وضع الوحدات → data/subjects/{الصف}/{المسار}/علم الاجتماع/unit_mode/book.json
...
# 🚦 المعالج الرئيسي
# ══════════════════════════════════════════════════
async def handle_sociology_request(req, clients: dict) -> dict:
