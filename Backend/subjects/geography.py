# ==================================================
# 📘 subjects/geography.py — مادة جغرافيا
# ==================================================
# الصفوف: الأول · الثاني الأدبي · الثالث الأدبي
#
...
#   📖 وضع الدروس  → data/subjects/{الصف}/{المسار}/جغرافيا/lessons_mode/
#   📄 وضع الوحدات → data/subjects/{الصف}/{المسار}/جغرافيا/unit_mode/book.json
...
# 🚦 المعالج الرئيسي
# ══════════════════════════════════════════════════
async def handle_geography_request(req, clients: dict) -> dict:
