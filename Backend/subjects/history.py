# ==================================================
# 📘 subjects/history.py — مادة تاريخ
# ==================================================
...
#   📖 وضع الدروس  → data/subjects/{الصف}/{المسار}/تاريخ/lessons_mode/
#   📄 وضع الوحدات → data/subjects/{الصف}/{المسار}/تاريخ/unit_mode/book.json
...
# 🚦 المعالج الرئيسي
# ══════════════════════════════════════════════════
async def handle_history_request(req, clients: dict) -> dict:
