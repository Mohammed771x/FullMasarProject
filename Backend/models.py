...
class AskRequest(BaseModel):
    ...
    # 🧠 **«تفكير» — زرٌّ بيد الطالب** (قرار المالك 2026-09-22: «هو الطالب
    #    يقدر يختار thinking ولا مش thinking؟ … حط خيار thinking وحط مش
    #    thinking، كما ChatGPT، عند الإرسال»).
    #
    # 📏 والفرقُ مقيسٌ على ٣٣ مسألةَ فيزياءٍ وكيمياءَ محسوبةٍ باليد ×٣:
    #      مُطفأً  ⇐ ٩٦٪ · ٠٫٨ ثانية · بلا رموزِ تفكير
    #      مُشغّلاً ⇐ ١٠٠٪ · ١٫٥ ثانية · ١٧٧ رمزاً للسؤال القصير
    #    وفي الشرح الطويل يقفز التفكيرُ إلى ٢٤٠٠ رمزٍ و٢٠ ثانية — ولهذا
    #    **الافتراضُ إطفاءٌ**: أكثرُ ما يُسأل شرحٌ لا حساب.
    #
    # 🕸️ والعميلُ القديم لا يرسله ⇒ `False` ⇒ سلوكُه لا يتغيّر.
    thinking: bool = False
